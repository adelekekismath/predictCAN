  ...
  features = signal([
    {
      ...
      desc: 'Chaque prédiction est accompagnée d\'une capture d\'écran de votre modèle ou algorithme avant le coup d\'envoi.',
    ...
    {
      title: 'Analyses Post-Match',
      desc: 'Accédez librement aux stratégies des meilleurs prédicteurs dès que le match a commencé.',
    ...
    },
    {
      ...
      desc: 'Gagnez des points pour chaque score exact et hissez-vous au sommet du classement mondial.',
